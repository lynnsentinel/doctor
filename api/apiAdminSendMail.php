...
$sqlWhere .= "a.ap_date = (CURDATE() + 2) AND a.ap_status != '2' AND a.ap_sendmail = '0' ";//status ไม่เท่ากัน ยกเงิก
...
foreach($data as $key => $value){
	...
	$sqlUpdate = "UPDATE appointment  SET ap_sendmail = '1' WHERE ap_id = '".$key."';";
