						...
						<div class="card-body">
							<form method="POST" action="#" class="needs-validation"> <!--was-validated-->
								...
								<div class="form-group mt-5">
									...
									<a href="register.php" class="link"><button type="button" class="btn btn-outline-success btn-lg btn-block mt-3">ลงทะเบียน</button></a>
								</div>
							</form>
...
<script>
	function login() {
        ...
        if (status) {
            ...
            dataArr = { 'type':'2', 'email': email, 'password': password }
