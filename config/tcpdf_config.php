...
if (!defined('K_TCPDF_EXTERNAL_CONFIG')) {
	...
	/*
	if($_GET['contract_type']==1 || $_GET['contract_type']==2){
		define('K_CELL_HEIGHT_RATIO', 1.20);
	}
	
	if($_GET['contract_type']==3){
		define('K_CELL_HEIGHT_RATIO', 1.4);
	}
	if($_GET['contract_type']==8){
		define('K_CELL_HEIGHT_RATIO', 1.4);
	}
	if($_GET['contract_type']==4){
		define('K_CELL_HEIGHT_RATIO', 1.8);
	}
	if($_GET['contract_type']==5){
		define('K_CELL_HEIGHT_RATIO', 1.8);
	}
	if($_GET['contract_type']==6){
		define('K_CELL_HEIGHT_RATIO', 1.8);
	}
	if($_GET['contract_type']==7){
		define('K_CELL_HEIGHT_RATIO', 1.8);
	}
	*/
	define('K_CELL_HEIGHT_RATIO', 1.8);
