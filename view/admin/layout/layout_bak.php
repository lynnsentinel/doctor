<?php 
	...
	if (empty($u_id) || empty($u_email) || $u_level != "admin") {
	...
	function layout_TopMenu() {
			$html = '<nav class="navbar navbar-expand-lg main-navbar bg-primary">
						...
						<ul class="navbar-nav navbar-right">
							<li class="d-none d-lg-inline-block"><a href="booking.php" class="nav-link nav-link-lg">รายการนัดหมาย</a></li>
							<li class="d-none d-lg-inline-block"><a href="#" class="nav-link nav-link-lg">ผู้ป่วย</a></li>
							<li class="d-none d-lg-inline-block"><a href="#" class="nav-link nav-link-lg">แพทย์</a></li>
							<li class="d-none d-lg-inline-block"><a href="#" class="nav-link nav-link-lg">ผู้ดูแล</a></li>
 ...
 คำนำหน้าแพทย์
									...
									<a href="#" class="dropdown-item has-icon">
										<i class="fas fa-cog"></i> คำนำหน้าชื่อ
									</a>
									<!--
									<a href="#" class="dropdown-item has-icon">
										<i class="fas fa-sign-out-alt"></i> ข้อมูลอื่นๆ 4
									</a>
									-->
								</div>
							</li>
