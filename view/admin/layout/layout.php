	...
	function layout_TopMenu() {
			$html = '<nav class="navbar navbar-expand-lg main-navbar bg-primary">
						...
						<ul class="navbar-nav navbar-right">
							...
							<li class="d-none d-lg-inline-block"><a href="patient.php" class="nav-link nav-link-lg">ผู้ป่วย</a></li>
							<li class="d-none d-lg-inline-block"><a href="doctor.php" class="nav-link nav-link-lg">แพทย์</a></li>
