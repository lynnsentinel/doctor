				...
				<section class="section">
					<div class="section-header">
						...
						<div class="col-4 text-right">
							<a href="doctor_detail.php?p=0"><button type="button" class="btn btn-primary"><i class="fas fa-plus"></i> เพิ่มรายชื่อแพทย์</button></a>
						</div>
					</div>
										...
										<div class="row m-0">
											...
											<div class="col-4 col-lg-auto">
												<div class="form-check m-0 pt-2 mt-1">
													<input class="form-check-input" type="radio" id="doctor_name" value="1" name="type_search" checked>
													<label class="form-check-label" for="doctor_name">แพทย์</label>
												</div>
											</div>
												...
												<table id="table_main" class="table table-striped table-bordered dataTable w-100 mb-0">
													<thead class="bg-light">
														...
														-->
															...
															<th width="15%" class="text-center">ห้อง</th>
															<th width="15%" class="text-center">วันเข้ารพ.</th>
...
<script>
	...
	function loadTable() {
		...
		$('#table_main').DataTable({
			...
			columns: [
 				/*
 				{ data:"doctor_id", class:"text-center", 
				...
				*/
				...
				{ data:"doctor_day", class:"", 
					render: function ( data, type, full, meta ){
						return data;
					}
				},
				{ data:"doctor_email", class:"", 
					render: function ( data, type, full, meta ){
						return data;
					}
				},
	...
	function editPassword(id){
		window.location.href = '<?php echo base_url(); ?>view/admin/doctor_password.php?p='+id;
	}

	function editData(id){
		window.location.href = '<?php echo base_url(); ?>view/admin/doctor_detail.php?p='+id;
	}
