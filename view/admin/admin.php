			...
			<div class="main-content">
				<section class="section">
					<div class="section-header">
						<div class="col-8">
							<h5>รายชื่อผู้ดูแล</h5>
						</div>
						<div class="col-4 text-right">
							<a href="admin_detail.php?p=0"><button type="button" class="btn btn-primary"><i class="fas fa-plus"></i> เพิ่มรายชื่อผู้ดูแล</button></a>
						</div>
					</div>
										...
										<div class="row m-0">
											...
											<div class="col-4 col-lg-auto">
												<div class="form-check m-0 pt-2 mt-1">
													<input class="form-check-input" type="radio" id="admin_name" value="1" name="type_search" checked>
													<label class="form-check-label" for="admin_name">ผู้ดูแล</label>
												</div>
											</div>
...
<script>
	...
	function loadTable() {
		...
		$('#table_main').DataTable({
			...
			columns: [
 				...
 				{ data:"admin_id", class:"text-center", 
					render: function ( data, type, full, meta ){
						return data;
					}
				},
				{ data:"admin_name", class:"", 
					render: function ( data, type, full, meta ){
						return data;
					}
				},
				{ data:"admin_email", class:"", 
					render: function ( data, type, full, meta ){
						return data;
					}
				},
	...
	function editPassword(id){
		window.location.href = '<?php echo base_url(); ?>view/admin/admin_password.php?p='+id;
	}

	function editData(id){
		window.location.href = '<?php echo base_url(); ?>view/admin/admin_detail.php?p='+id;
	}
