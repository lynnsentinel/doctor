				...
				<section class="section">
					<div class="section-header">
						...
						<div class="col-4 text-right">
							<a href="chamber_detail.php?p=0"><button type="button" class="btn btn-primary"><i class="fas fa-plus"></i> เพิ่มห้อง</button></a>
						</div>
					</div>
...
<script>
	...
	function loadTable() {
		...
		$('#table_main').DataTable({
			...
			columns: [
				...
				{ data:"cham_id", class:"text-center",
					render: function ( data, type, full, meta ){
						let html = "";
	...
	function editData(id){
		window.location.href = '<?php echo base_url(); ?>view/admin/chamber_detail.php?p='+id;
	}
