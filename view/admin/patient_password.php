													...
													<div class="row">
														<div class="col-12">
															<div class="form-group m-0">
																...
																<input id="patient_name" type="text" class="form-control" name="patient_name" value="">
...
<script>
				...
				success: function (res) {
					...
					if (row.length > 0) {
						row.map( e => {
							...
							$('#patient_name').val(e.patient_title_name+' '+e.patient_name);
	...
	function changePassword() {
        ...
        if (status) {
			...
			dataArr = { 'type':'change', 'patient_id': patient_id, 'password_new1': password_new1}

			$.ajax({
				type: "POST",
				url: "<?php echo base_url(); ?>api/apiPatientPassword.php",
				data: dataArr,
				dataType: "json",
				beforeSend: function() { },
