				...
				<section class="section">
					<div class="section-header">
						...
						<div class="col-4 text-right">
							<a href="doctor_title_detail.php?p=0"><button type="button" class="btn btn-primary"><i class="fas fa-plus"></i> เพิ่มคำนำแพทย์</button></a>
						</div>
					</div>
											...
											<div class="col-12 table-responsive">
												<table id="table_main" class="table table-striped table-bordered dataTable w-100 mb-0">
													<thead class="bg-light">
														<tr>
															<th width="15%" class="text-center">คำนำหน้าแพทย์</th>
...
<script>
	...
	function loadTable() {
		...
		$('#table_main').DataTable({
			...
			columns: [
				...
				{ data:"doctor_title_name", class:"", 
					render: function ( data, type, full, meta ){
						return data;
					}
				},

				{ data:"doctor_title_id", class:"text-center",
					render: function ( data, type, full, meta ){
						let html = "";
	...
	function editData(id){
		window.location.href = '<?php echo base_url(); ?>view/admin/doctor_title_detail.php?p='+id;
	}
			...
			Swal.fire({
				...
				if (result.value) {
					$.ajax({
						...
						data: { 'type':'delete', 'doctor_title_id':id },
						dataType: "json",
						beforeSend: function() {},
