		...
		<div class="main-wrapper main-wrapper-1">
			...
			<div class="main-content">
				<section class="section">
					...
					<a href="admin.php"><button type="button" class="btn btn-danger m-3">กลับไปหน้ารายชื่อผู้ดูแล</button></a>
													...
													<div class="row">
														<div class="col-12">
															<div class="form-group m-0">
																...
																<input id="admin_name" type="text" class="form-control" name="admin_name" value="">
...
<script>
	...
	function changePassword() {
        ...
        if (status) {
			...
			dataArr = { 'type':'change', 'admin_id': admin_id, 'password_new1': password_new1}

			$.ajax({
				type: "POST",
				url: "<?php echo base_url(); ?>api/apiAdminPassword.php",
				data: dataArr,
				dataType: "json",
				beforeSend: function() { },
